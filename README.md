MSc Thesis: Spatial and Temporal Variation of Water Quality Parameters in Lake Tana Using Remote Sensing, Ethiopia https://img.shields.io/badge/Platform-Google%2520Earth%2520Engine-blue https://img.shields.io/badge/Satellite-MODIS%2520MOD09Q1-green https://img.shields.io/badge/Period-2008%25E2%2580%25932018-orange https://img.shields.io/badge/License-MIT-lightgrey https://img.shields.io/badge/Samples-143%2520in--situ-brightgreen

👨‍🎓 Author Information Name: Bekalu Weretaw Asres Degree: Master of Science in Hydraulic Engineering University: Bahir Dar University, Institute of Technology Supervisor: Fasikaw Atanaw (PhD) Submission Date: 12 February 2020
...
🎯 Research Objectives Analyze spatial variation of water quality parameters in Lake Tana
...
🔬 Field Data Collection In-situ Measurements (143 Samples) Sampling Campaigns:
...
🛠️ Methodology Overview Data Acquisition: MODIS surface reflectance (MOD09Q1, 2008-2018) accessed via Google Earth Engine.
...
MSc_Thesis_LakeTana/ ├── scripts/ │ ├── main/GEE_Thesis_With_FieldData.js # Complete analysis script │ └── utils/field_data_loader.js # 143 samples data handler ├── docs/setup_guide.md # Usage instructions ├── thesis/abstract.md # Thesis abstract ├── LICENSE ├── CITATION.cff ├── .gitignore └── README.md

Quick Start

Access the Google Earth Engine Platform Navigate to the Google Earth Engine Code Editor. You will need a registered GEE account.

Prepare Your Field Data Open scripts/utils/field_data_loader.js
...
Run the Analysis in GEE Copy the entire contents of scripts/main/GEE_Thesis_With_FieldData.js into the GEE code editor.
...
Adapt for Your Own Study Area To apply this methodology to a different lake:
...
📊 Available Scripts Main Analysis Script GEE_Thesis_With_FieldData.js - Complete integrated analysis including:
...
Field Data Utilities field_data_loader.js - Primary field data handler for 143 samples

📈 Key Findings Spatial Patterns: Higher turbidity and nutrient concentrations observed in the northern shallow regions of Lake Tana.
...
@mastersthesis{asres2020laketana, author = {Bekalu Weretaw Asres}, title = {Spatial and Temporal Variation of Water Quality Parameters in Lake Tana Using Remote Sensing, Ethiopia}, school = {Bahir Dar University, Institute of Technology}, year = {2020}, address = {Bahir Dar, Ethiopia}, note = {Supervised by Fasikaw Atanaw (PhD)}, url = {https://github.com/BekaluWeretaw/MSc_Thesis_LakeTana} }

Contact Author: Bekalu Weretaw Asres
...
🙏 Acknowledgments Primary Supervisor: Dr. Fasikaw Atanaw
...
📜 License This work is licensed under the MIT License - see the LICENSE file for details.

MSc Thesis: Spatial and Temporal Variation of Water Quality Parameters in Lake Tana Using Remote Sensing, Ethiopia
https://img.shields.io/badge/Platform-Google%2520Earth%2520Engine-blue
https://img.shields.io/badge/Satellite-MODIS%2520MOD09Q1-green
https://img.shields.io/badge/Period-2008%25E2%2580%25932018-orange
https://img.shields.io/badge/License-MIT-lightgrey
https://img.shields.io/badge/Samples-143%2520in--situ-brightgreen
